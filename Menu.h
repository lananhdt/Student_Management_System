    ...
    void menuStudent() {
        while (true) {
            ...
            if (ch == 0) break;
                ...
                if (stm.add(s)) {
                    FileManager::saveStudents("data/students.txt", stm);
    ...
    void menuSubject() {
        while (true) {
            ...
            if (ch == 0) break;
                ...
                sbm.add(s);
                FileManager::saveSubjects("data/subjects.txt", sbm);
                ...
                if (cm.addClass(cs)) {
                    FileManager::saveClasses("data/classes.txt", "data/class_roster.txt", cm);
    ...
    void menuScore() {
        while (true) {
            ...
            if (ch == 0) break;
                ...
                FileManager::saveScores("data/scores.txt", scm);
